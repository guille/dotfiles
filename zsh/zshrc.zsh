...
# Generated with printf %q "$(vivid generate molokai)" for escaping
...
FZF_TAB_GROUP_COLORS=(
    $'\033[38;5;81m' $'\033[38;5;148m' $'\033[33m' $'\033[38;5;141m' $'\033[38;5;196m' $'\033[38;5;27m' $'\033[36m' \
    $'\033[38;5;100m' $'\033[38;5;208m' $'\033[91m' $'\033[38;5;80m' $'\033[92m' \
    $'\033[38;5;214m' $'\033[38;5;165m' $'\033[38;5;124m' $'\033[38;5;120m'
)
zstyle ':fzf-tab:*' group-colors $FZF_TAB_GROUP_COLORS
# print_fzf_tab_colors() {
#   local reset=$'\033[0m'
#   local i
#   for (( i=1; i<=${#FZF_TAB_GROUP_COLORS[@]}; i++ )); do
#     printf "%2d: %s████%s\n" $((i-1)) "${FZF_TAB_GROUP_COLORS[$i]}" "$reset"
#   done
# }

# Generated by Powerlevel10k configuration wizard on 2023-12-12 at 00:12 CET.
...
# slanted separators, slanted heads, flat tails, 2 lines, solid, left frame,
...
#
# (Updated 2026-02 with patches up to 8ed1f58)
# See https://github.com/romkatv/powerlevel10k/commits/master/config/p10k-rainbow.zsh
# (Also added POWERLEVEL9K_TERM_SHELL_INTEGRATION=true)
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=40
  ...
  function my_git_formatter() {
    ...
    # (EDITED) Now remote-related status, add separator " -- " and skip number of commits
    if (( VCS_STATUS_COMMITS_AHEAD || VCS_STATUS_COMMITS_BEHIND )); then
      res+="  " # (EDITED) Separator
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND=238
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=238
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=126
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      ...
      '*admin*'  WRITE
      '*'        DEFAULT)
  # read-only have green background (2), write have red (1)
  #
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND=7
  typeset -g POWERLEVEL9K_AWS_DEFAULT_BACKGROUND=2
  # typeset -g POWERLEVEL9K_AWS_DEFAULT_VISUAL_IDENTIFIER_EXPANSION='⭐'
  typeset -g POWERLEVEL9K_AWS_WRITE_FOREGROUND=7
  typeset -g POWERLEVEL9K_AWS_WRITE_BACKGROUND=1
